      ...
      <div className="container mx-auto px-6">
        ...
        >
          {partners.map((partner, index) => (
            ...
            >
              <div className="px-8 py-4 border border-border rounded-lg bg-card/50 backdrop-blur-sm group-hover:border-primary/30 transition-all duration-300">
        ...
        <div className="sr-only">
          <p>GoHighLevel Partner Bielefeld, Funnelmate Experte, HighLevel Agentur Deutschland, Marketing Automatisierung NRW, CRM System Beratung, Funnel Builder Experte, Online Marketing Bielefeld, Digital Marketing Automatisierung, Lead Generation Experte, Sales Funnel Spezialist</p>
        </div>
      </div>
    </section>
  );
